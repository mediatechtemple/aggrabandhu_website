  ...
  return (
    <div className="bg-black w-full py-8">
      <div className="flex flex-col md:flex-row justify-around items-center gap-8">
        ...
        <Link href="https://wa.me/917830305040" target="blank" >Support</Link>
          <Link href={"privacy"}>Privacy Policy</Link>
          <Link href={"rule"}>Rules & Regulations</Link>
          <Button onClick={() => router.push('contact-us')}  className="rounded-full font-semibold uppercase bg-orange-600 border border-green-500 hover:bg-orange-700">
            Contact Us
          </Button>
        </div>
      </div>
