...
const page = () => {
  ...
  //       <li><strong>Application</strong> refers to AGGRABANDHU SEVARTH SANSTHAN, the software program provided by the Company.</li>
  //       <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AGGRABANDHU SEVARTH SANSTHAN REG., Vibhab Nagar, Firozabad, Uttar Pradesh 283203.</li>
