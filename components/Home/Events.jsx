        ...
        <div className="event-ro flex flex-wrap -mx-4">
          <div className="col-md-4 col-sm-6 px-4 mb-8 w-full md:w-1/3 sm:w-1/2">
            <div className="event-box text-center">
              <Image src="/Images/slider/slide-01.jpg" alt="" layout="responsive" width={500} height={300} className="mb-4" />
              ...
              <p className="desic text-sm mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
              <button className="bg-green-500 text-white px-4 py-2 rounded text-sm">Donate Now</button>
            </div>
          </div>
          <div className="col-md-4 col-sm-6 px-4 mb-8 w-full md:w-1/3 sm:w-1/2">
            <div className="event-box text-center">
              <Image src="/Images/slider/slide-02.jpg"  alt="" layout="responsive" width={500} height={300} className="mb-4" />
              <h4 className="text-xl font-semibold mb-2">Child Education in Africa</h4>
              <p className="raises mb-2 text-base">
                <span className="text-green-600">Raised : $34,425</span> / $500,000
              </p>
          ...
          <div className="col-md-4 col-sm-6 px-4 mb-8 w-full md:w-1/3 sm:w-1/2">
            <div className="event-box text-center">
              <Image src="/Images/slider/slide-03.jpg"  alt="" layout="responsive" width={500} height={300} className="mb-4" />
              <h4 className="text-xl font-semibold mb-2">Child Education in Africa</h4>
              <p className="raises mb-2 text-base">
                <span className="text-green-600">Raised : $34,425</span> / $500,000
              </p>
